<%@page import="java.sql.*"%>
    <%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        String ok = request.getParameter("p");
      %>

                <div id="wrapper-login" class="cover-container d-flex h-100 p-3 mx-auto flex-column text-center">
                    <main role="main" class="inner cover">

                        <form action="uValidacion.jsp" method="get" accept-charset="utf-8" id="formulario" class="form-signin">
                            ...
                            <span id="<% out.print(ok); %>" style="display: none;" class='alert alert-success mt-3' role='alert'>Registrado correctamente</span><br>
